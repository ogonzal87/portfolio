  ...
  return <div>
      ...
      <div className="about-page">
        <SectionHero>
          ...
          <h6 className="taking-clients"><i>Currently <strong>not</strong> taking on any new projects or clients but willing to meet for a cup of coffee.</i></h6>
          </div>
        </SectionHero>
      </div>
      <PortfolioFooter />

      ...
      <div className="project-page">
        ...
        <div className="case-study-dossier-container">
          <div className="dossier__problem-container">
            ...
            <p>
              As a presenter, you are running blind while in front of an audience since they are only able to provide feedback <i>after</i> the presentation or you rely on a few to speak for the group. As an attendee, my research showed that <strong>9 out of 10 people found themselves not wanting to participate out of fear of revealing themselves to other attendees and the presenter</strong>. I saw these as missed opportunities for learning and participation.
            </p>
          </div>
          <div className="dossier__users-container">
            <p className="special-text-styling">Primary Users</p>
            <p>Attendees and presenters at social gatherings such as classes or talks. </p>
          </div>
          ...
          <div className="dossier__tools-container">
            ...
            <p>Pen, paper, AngularJS, Firebase, Sketch App, SASS, Gulp.JS, Node.js, Invision.</p>
          </div>
          ...
          <div className="dossier__constraints-container">
            ...
            <p>Avoid getting the audience distracted and provide anonymity for them.</p>
          </div>
        ...
        <div className="project-img-grid">
          ...
          <p>
            Now that I had data backing up my assumptions, my testable hypothesis then became: <strong><i>If</i></strong> people feel afraid of revealing themselves when asking questions or expressing their opinions at social settings, <strong><i>then</i></strong> aggregating each participant's input and displaying it publicly while maintaining their privacy will improve their participation and subsequent understanding of the subject being presented since the presenter will hopefully adjust to the needs of the audience based on the data fed in real time.
          </p>
        </div>
        ...
        <div className="design-process__section-container">
          ...
          <div>
            <p>I was designing two solutions for two separate users; the audience and the presenter. My original requirements were: </p>
            <ol>
              <li>The audience can provide feedback to the Presenter in real time</li>
              <li>The audience can see how everyone is feeling in real time all the time</li>
              <li>The presenter can see how the audience is feeling in real time</li>
              <li>The presenter can ask questions to the audience and see the results in real time</li>
            </ol>

            <p>The idea was to create some sort of visual indicator that would allow the presenter and audience to know the real-time feelings of the class or presentation. It had to be relatable and had to feel like you could empathize with it as an attendee.</p>

            <p>I divided the app into two separate experiences; one for the Presenter, and the other for the Attendees. The presenter would have a Dashboard where he/she would be able to see all data coming in real time. The Attendee would have a simple interface where they could provide feedback. However, both interfaces must be connected by an artifact of emotion so that the presenter and the audience could see the aggregate input of everyone.</p>
          </div>
        </div>
        ...
        <div className="design-process__section-container">
          ...
          <div>
            <p>My approach here was to learn as fast as I could through rapid testing. Below you can see the first iterations of the User Interfaces and how it progressed with each cycle.</p>
          </div>
        ...
        <div className="design-process__section-container">
          ...
          <div>
            <p>I decided to use AngularJS with a Component Architecture for my front-end coupled with Bootstrap, and Firebase for my back-end since I needed something that was scalable and that provided me with real-time features. I also wrote my own build-task setup using Gulp.js - the source code is available on Github.</p>
        ...
        <div className="design-process__section-container no-top-margin">
          ...
          <div>
            <p>The original idea was to let the presenter customize the defaulted questions in the app; <i>Are you lost? Can you hear? and How do you like the speed?</i>. I need to find the time to implement the feature.</p>
          </div>
        </div>
